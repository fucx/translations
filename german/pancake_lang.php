...
$lang = array (
  ...
  'invoices:sentbutunpaid' => 'Versendete aber noch unbezahlte Rechnungen',
  ...
  'kitchen:people_in_discussion' => 'Beteiligte Personen',
...
:3',
  ...
  'dashboard:view_all_outstanding_invoices' => 'Alle offenen Rechnungen ansehen',
  ...
  "invoices:pancake_cannot_auto_charge" => "Es gibt keine gespeicherten Zahlungsdaten für diesen Kunden, daher kann Pancake nicht automatisch abbuchen. Der Kunde muss Sie mindestens einmal über Stripe bezahlen, damit seine Zahlungsdaten gespeichert werden können.",
  "invoices:auto_charge_needs_pancake_cron_job" => 'Um automatisch von Kunden abbuchen zu können, müssen Sie einen <a target="_blank" href="https://www.pancakeapp.com/documentation/cron">Pancake Cron Job</a> anlegen.',
  ...
  "settings:you_are_signed_in" => "Sie sind angemeldet als:1.<br />Klicken Sie auf die Schaltfläche unten, wenn Sie Ihre Daten aktualisieren oder ein anderes Konto verwenden möchten.",
  "settings:you_are_using_old_auth" => "Pancake sendet derzeit E-Mails als :1 unter Verwendung Ihrer E-Mail und Ihres Passworts.<br />Klicken Sie auf die Schaltfläche unten, um auf eine sicherere Art der Nutzung von Google Mail umzusteigen.",
  'credit_notes:messageupdated' => 'Die Gutschrift wurde aktualisiert!',
  'credit_notes:resend' => 'Gutschrift erneut senden',
  "global:support" => "Hilfe / Support",
  "settings:filesystem" => "Speicherort für Uploads",
  "settings:filesystem_local" => "Uploads-Ordner",
  "filesystem:s3_access_key" => "Access Key",
  "filesystem:s3_secret_key" => "Secret Key",
  "filesystem:s3_prefix" => "Ordner (optional)",
  "filesystem:s3_bucket" => "S3 Bucket",
  "invoices:amount_due" => "Fälliger Betrag",
